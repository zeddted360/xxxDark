...
const Header = () => {
  ...
  return (
    <>
      <div
        id="header"
        className={`header bg-black px-8 flex justify-between z-50 text-gray-50 fixed w-full top-0 ${
      ...
      >
        ...
        <div className="desktopNavBar hidden lg:flex justify-around items-center gap-4">
